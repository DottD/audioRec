...
public:
	...
	/** Setter for compareIntra */
	void setTestIntra(bool testIntra);
...
Q_SIGNALS:
	...
	/** Signal emitted when a new curve is fitted. */
	void fittingReady(QVector<double> coeff, QVector<double> x);
};
